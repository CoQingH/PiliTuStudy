...
class MainActivity : AudioServiceActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        methodChannel.setMethodCallHandler { call, result ->
            if (call.method == "back") {
                ...
                try {
                    val intent = Intent(android.provider.Settings.ACTION_APP_OPEN_BY_DEFAULT_SETTINGS, Uri.parse("package:" + context.packageName))
    ...
    override fun onPictureInPictureModeChanged(isInPictureInPictureMode: Boolean, newConfig: Configuration?) {
        ...
        MethodChannel(flutterEngine!!.getDartExecutor()!!.getBinaryMessenger(), "floating").invokeMethod("onPipChanged", isInPictureInPictureMode)
    }
}
