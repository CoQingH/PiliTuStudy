...
import 'package:pilistudy/http/ua_type.dart';
...
import 'package:pilistudy/plugin/pl_player/models/data_status.dart';
...
import 'package:pilistudy/services/eye_care_service.dart';
...
import 'package:pilistudy/utils/page_utils.dart' show PageUtils;
...
class PlPlayerController {
  ...
  bool get showRelatedVideo => Pref.showRelatedVideo;
  bool get showVideoReply => Pref.showVideoReply;
  ...
  PlPlayerController._() {
    ...
    // 护眼回调
    eyeCareService.onPauseRequired = () => pause(isInterrupt: true);
    eyeCareService.onRestComplete = () => play(hideControls: true);
  ...
  Future<void> play({bool repeat = false, bool hideControls = true}) async {
    ...
    eyeCareService.onPlaybackStarted();
  ...
  Future<void> pause({bool notify = true, bool isInterrupt = false}) async {
    ...
    playerStatus.status.value = PlayerStatus.paused;
    eyeCareService.onPlaybackPaused();
