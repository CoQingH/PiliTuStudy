import 'package:pilistudy/pages/about/view.dart';
import 'package:pilistudy/pages/article/view.dart';
import 'package:pilistudy/pages/article_list/view.dart';
import 'package:pilistudy/pages/blacklist/view.dart';
import 'package:pilistudy/pages/danmaku_block/view.dart';
import 'package:pilistudy/pages/dynamics/view.dart';
import 'package:pilistudy/pages/dynamics_create_vote/view.dart';
import 'package:pilistudy/pages/dynamics_detail/view.dart';
import 'package:pilistudy/pages/dynamics_topic/view.dart';
import 'package:pilistudy/pages/dynamics_topic_rcmd/view.dart';
import 'package:pilistudy/pages/fan/view.dart';
import 'package:pilistudy/pages/fav/view.dart';
import 'package:pilistudy/pages/fav_create/view.dart';
import 'package:pilistudy/pages/fav_detail/view.dart';
import 'package:pilistudy/pages/fav_search/view.dart';
import 'package:pilistudy/pages/follow/view.dart';
import 'package:pilistudy/pages/follow_search/view.dart';
import 'package:pilistudy/pages/history/view.dart';
import 'package:pilistudy/pages/history_search/view.dart';
import 'package:pilistudy/pages/home/view.dart';
import 'package:pilistudy/pages/hot/view.dart';
import 'package:pilistudy/pages/later/view.dart';
import 'package:pilistudy/pages/later_search/view.dart';
import 'package:pilistudy/pages/live_dm_block/view.dart';
import 'package:pilistudy/pages/live_room/view.dart';
import 'package:pilistudy/pages/login/view.dart';
import 'package:pilistudy/pages/main/view.dart';
import 'package:pilistudy/pages/match_info/view.dart';
import 'package:pilistudy/pages/member/view.dart';
import 'package:pilistudy/pages/member_dynamics/view.dart';
import 'package:pilistudy/pages/member_profile/view.dart';
import 'package:pilistudy/pages/member_search/view.dart';
import 'package:pilistudy/pages/member_upower_rank/view.dart';
import 'package:pilistudy/pages/msg_feed_top/at_me/view.dart';
import 'package:pilistudy/pages/msg_feed_top/like_detail/view.dart';
import 'package:pilistudy/pages/msg_feed_top/like_me/view.dart';
import 'package:pilistudy/pages/msg_feed_top/reply_me/view.dart';
import 'package:pilistudy/pages/msg_feed_top/sys_msg/view.dart';
import 'package:pilistudy/pages/music/view.dart';
import 'package:pilistudy/pages/search/view.dart';
import 'package:pilistudy/pages/search_result/view.dart';
import 'package:pilistudy/pages/search_trending/view.dart';
import 'package:pilistudy/pages/setting/extra_setting.dart';
import 'package:pilistudy/pages/setting/pages/bar_set.dart';
import 'package:pilistudy/pages/setting/pages/color_select.dart';
import 'package:pilistudy/pages/setting/pages/display_mode.dart';
import 'package:pilistudy/pages/setting/pages/font_size_select.dart';
import 'package:pilistudy/pages/setting/pages/logs.dart';
import 'package:pilistudy/pages/setting/pages/play_speed_set.dart';
import 'package:pilistudy/pages/setting/play_setting.dart';
import 'package:pilistudy/pages/setting/privacy_setting.dart';
import 'package:pilistudy/pages/setting/recommend_setting.dart';
import 'package:pilistudy/pages/setting/style_setting.dart';
import 'package:pilistudy/pages/setting/video_setting.dart';
import 'package:pilistudy/pages/setting/view.dart';
import 'package:pilistudy/pages/settings_search/view.dart';
import 'package:pilistudy/pages/space_setting/view.dart';
import 'package:pilistudy/pages/sponsor_block/view.dart';
import 'package:pilistudy/pages/subscription/view.dart';
import 'package:pilistudy/pages/subscription_detail/view.dart';
import 'package:pilistudy/pages/video/view.dart';

import 'package:pilistudy/pages/webview/view.dart';
import 'package:pilistudy/pages/whisper/view.dart';
import 'package:pilistudy/pages/whisper_detail/view.dart';
