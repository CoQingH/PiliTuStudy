...
import 'package:pilistudy/common/widgets/pair.dart';
import 'package:pilistudy/http/constants.dart';
import 'package:pilistudy/models/common/dynamic/dynamic_badge_mode.dart';
import 'package:pilistudy/models/common/dynamic/up_panel_position.dart';
import 'package:pilistudy/models/common/member/tab_type.dart';
import 'package:pilistudy/models/common/msg/msg_unread_type.dart';
import 'package:pilistudy/models/common/sponsor_block/segment_type.dart';
import 'package:pilistudy/models/common/sponsor_block/skip_type.dart';
import 'package:pilistudy/models/common/super_resolution_type.dart';
...
import 'package:pilistudy/models/common/video/live_quality.dart';
import 'package:pilistudy/models/common/video/subtitle_pref_type.dart';
import 'package:pilistudy/models/common/video/video_decode_type.dart';
import 'package:pilistudy/models/common/video/video_quality.dart';
import 'package:pilistudy/models/user/danmaku_rule.dart';
import 'package:pilistudy/models/user/info.dart';
import 'package:pilistudy/plugin/pl_player/models/bottom_progress_behavior.dart';
import 'package:pilistudy/plugin/pl_player/models/fullscreen_mode.dart';
import 'package:pilistudy/plugin/pl_player/models/play_repeat.dart';
import 'package:pilistudy/utils/context_ext.dart';
...
abstract class Pref {
  ...
  static bool get contentFilterGender =>
      _setting.get(SettingBoxKey.contentFilterGender, defaultValue: false);

  static bool get contentFilterNsfw =>
      _setting.get(SettingBoxKey.contentFilterNsfw, defaultValue: false);

  static String get contentFilterGenderCustom =>
      _setting.get(SettingBoxKey.contentFilterGenderCustom, defaultValue: '');

  static String get contentFilterNsfwCustom =>
      _setting.get(SettingBoxKey.contentFilterNsfwCustom, defaultValue: '');

  static bool get contentFilterPolitical =>
      _setting.get(SettingBoxKey.contentFilterPolitical, defaultValue: false);

  static String get contentFilterPoliticalCustom =>
      _setting.get(SettingBoxKey.contentFilterPoliticalCustom,
          defaultValue: '');
  ...
  static int get lastDailyLimitIncreaseMs =>
      _setting.get(SettingBoxKey.lastDailyLimitIncreaseMs, defaultValue: 0);

  static set lastDailyLimitIncreaseMs(int value) {
    _setting.put(SettingBoxKey.lastDailyLimitIncreaseMs, value);
  }

  static bool get enableKnowledgeMode =>
      _setting.get(SettingBoxKey.enableKnowledgeMode, defaultValue: false);

  static String get knowledgeZoneWhitelist =>
      _setting.get(SettingBoxKey.knowledgeZoneWhitelist, defaultValue: '知识|科技|数码|编程|计算机|数学|物理');

  static bool get disableRcmdFeed =>
      _setting.get(SettingBoxKey.disableRcmdFeed, defaultValue: false);

  static bool get enableStudyMode =>
      _setting.get(SettingBoxKey.enableStudyMode, defaultValue: false);

  static bool get disableAllComments =>
      _setting.get(SettingBoxKey.disableAllComments, defaultValue: false);

  static bool get disableAllDanmaku =>
      _setting.get(SettingBoxKey.disableAllDanmaku, defaultValue: false);

  static bool get enableEyeCare =>
      _setting.get(SettingBoxKey.enableEyeCare, defaultValue: false);

  static int get eyeCareIntervalMinutes =>
      _setting.get(SettingBoxKey.eyeCareIntervalMinutes, defaultValue: 20);

  static int get eyeCareRestSeconds =>
      _setting.get(SettingBoxKey.eyeCareRestSeconds, defaultValue: 20);
  ...
  static int get minDurationForSearch =>
      _setting.get(SettingBoxKey.minDurationForSearch, defaultValue: 0);
