...
import 'package:pilistudy/pages/fav/article/controller.dart';
import 'package:pilistudy/pages/fav/cheese/controller.dart';
import 'package:pilistudy/pages/fav/note/controller.dart';
import 'package:pilistudy/pages/fav/video/controller.dart';
import 'package:pilistudy/pages/fav_folder_sort/view.dart';
                ...
                switch (FavTabType.values[index]) {
                  ...
                  case FavTabType.article:
                    Get.find<FavArticleController>().scrollController
                        .animToTop();
                    break;
                  case FavTabType.note:
                    try {
                      Get.find<FavNoteController>(tag: 'true')
                          .scrollController
                          .animToTop();
                    } catch (_) {
                      Get.find<FavNoteController>(tag: 'false')
                          .scrollController
                          .animToTop();
                    }
                    break;
