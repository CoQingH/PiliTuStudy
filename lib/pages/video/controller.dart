...
import 'package:pilistudy/models/common/sponsor_block/segment_model.dart';
...
import 'package:pilistudy/models/common/video/source_type.dart';
...
import 'package:pilistudy/models/common/video/video_type.dart';
import 'package:pilistudy/models/video/play/url.dart';
import 'package:pilistudy/models_new/media_list/data.dart';
import 'package:pilistudy/models_new/media_list/media_list.dart';
import 'package:pilistudy/models_new/sponsor_block/segment_item.dart';
import 'package:pilistudy/models_new/video/video_detail/page.dart';
import 'package:pilistudy/models_new/video/video_pbp/data.dart';
import 'package:pilistudy/models_new/video/video_play_info/data.dart';
import 'package:pilistudy/models_new/video/video_play_info/subtitle.dart';
import 'package:pilistudy/models_new/video/video_stein_edgeinfo/data.dart';
import 'package:pilistudy/services/usage_limit_service.dart';
import 'package:pilistudy/pages/search/widgets/search_text.dart';
import 'package:pilistudy/pages/video/introduction/ugc/controller.dart';
import 'package:pilistudy/pages/video/medialist/view.dart';
import 'package:pilistudy/pages/video/note/view.dart';
import 'package:pilistudy/pages/video/post_panel/view.dart';
import 'package:pilistudy/pages/video/send_danmaku/view.dart';
...
import 'package:pilistudy/plugin/pl_player/models/data_source.dart';
import 'package:pilistudy/plugin/pl_player/models/heart_beat_type.dart';
...
import 'package:pilistudy/utils/video_utils.dart';
...
class VideoDetailController extends GetxController
  ...
  void onInit() {
    ...
    if (sourceType == SourceType.fav) {
      final favId = args['mediaId'] as int?;
      if (favId != null && usageLimitService.exemptFavIds.contains(favId)) {
        usageLimitService.markExempted();
      }
    }
  ...
  @override
  void onClose() {
    usageLimitService.resetExemption();
    tabCtr.dispose();
    scrollCtr
