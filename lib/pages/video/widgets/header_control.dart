...
import 'package:pilistudy/common/widgets/marquee.dart';
...
import 'package:pilistudy/pages/setting/widgets/switch_item.dart';
...
import 'package:pilistudy/pages/video/introduction/ugc/widgets/action_item.dart';
import 'package:pilistudy/pages/video/introduction/ugc/widgets/menu_row.dart';
import 'package:pilistudy/pages/video/introduction/ugc/widgets/triple_state.dart';
        ...
        Row(
          children: [
            ...
            if ((introController.videoDetail.value.title != null) &&
              ...
              const Spacer(),
            // show current datetime + usage status
            Obx(
              () {
